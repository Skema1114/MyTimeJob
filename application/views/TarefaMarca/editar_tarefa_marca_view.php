      ...
      <div class="col-md-12">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
           ...
           <form action="<?=site_url('tarefamarca/gravar')?>" id="frmTarefaMarca" method="post" accept-charset="utf-8" class="auto-config" >
             <div class='form-group required'>
                ...
                <input required type='text' id='nome' autofocus name='nome' class='form-control' value="<?=$this->tarefaMarca_modelo->nome?>">

                <label for='descricao' class="control-label"><strong>Descrição</strong></label>
                <input type='text' id='descricao' name='descricao' class='form-control' value="<?=$this->tarefaMarca_modelo->descricao?>">
            </div>
            <div class='row'>

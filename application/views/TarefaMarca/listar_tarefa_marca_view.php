            ...
            <table class="table bootstrap-datatable countries">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <?php echo anchor('tarefamarca/editar/'.$tarefaMarca->idMarca,'<span class="glyphicon glyphicon-pencil"></span>')?>
                  </td>
                  <td>
                    <?php echo anchor('tarefamarca/remover/'.$tarefaMarca->idMarca,'<span class="glyphicon glyphicon-remove"></span>')?>
                  </td>
                </tr>
                <?php endforeach;?>
              </tbody>

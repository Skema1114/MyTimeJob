    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
          ...
          <li><i class="fa fa-user"></i>Editar Tarefa Tipo</li>
        </ol>
      </div>
    </div>
    <!-- Today status end -->
      ...
      <div class="col-md-12">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
           ...
           <form action="<?=site_url('tarefatipo/gravar')?>" id="frmTarefaTipo" method="post" accept-charset="utf-8" class="auto-config" >
             <div class='form-group required'>
                ...
                <input required type='text' id='nome' autofocus name='nome' class='form-control' value="<?=$this->tarefaTipo_modelo->nome?>">

                <label for='descricao' class="control-label"><strong>Descrição</strong></label>
                <input type='text' id='descricao' name='descricao' class='form-control' value="<?=$this->tarefaTipo_modelo->descricao?>">
            </div>
            <div class='row'>

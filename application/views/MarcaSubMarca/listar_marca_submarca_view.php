    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
          ...
          <li><i class="fa fa-laptop"></i>Sub Marca</li>
        </ol>
      </div>
    </div>
            ...
            <tbody>
             <?php foreach ($submarca as $marcaSubMarca):?>
              <tr>
                ...
                <td><?php echo anchor('marcasubmarca/editar/'.$marcaSubMarca->idSubMarca,'<span class="glyphicon glyphicon-pencil"></span>')?></td>
                <td><?php echo anchor('marcasubmarca/remover/'.$marcaSubMarca->idSubMarca,'<span class="glyphicon glyphicon-remove"></span>')?></td>
              </tr>
            <?php endforeach;?>
          </tbody>
        </table>

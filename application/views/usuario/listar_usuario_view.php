             ...
             <table class="table bootstrap-datatable countries">
               ...
               <tbody>
                 ...
                 <tr>
                   ...
                   <td>
                     <?php echo anchor('usuario/editar/'.$usuario->idUsuario,'<span class="glyphicon glyphicon-pencil"></span>')?>
                   </td>
                   <td>
                     <?php echo anchor('usuario/remover/'.$usuario->idUsuario,'<span class="glyphicon glyphicon-remove"></span>','id="'.$usuario->idUsuario.'"')?>
                   </td>
                 </tr>
                 <?php endforeach;?>
               </tbody>

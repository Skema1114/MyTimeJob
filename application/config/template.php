 ...
 * default files
 */
$config['default_js'] = array('assets/js/jquery.js','assets/bootstrap/js/bootstrap.min.js');
$config['default_css'] = array('assets/bootstrap/css/bootstrap.min.css');
